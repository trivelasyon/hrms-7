...
public class JobTittleController {
	...
	public DataResult<List<JobTittle>> getJobList(){
	...
	@PostMapping("/add")
	public Result jobListAdd(@RequestBody JobTittle jobTittle) {
		return this.jobTittleService.addJobTittle(jobTittle);
	}
